"""
Persistence - Auto-save for CLI Sequences
...
Example:
    ...
    # Replay
    seq = persistence.load("seq-abc123")
"""
...
class Persistence:
    ...
    def save(self, sequence_data: Dict[str, Any]) -> str:
        """
    ...
    def load(self, sequence_id: str) -> Optional[Dict[str, Any]]:
        """
        ...
        Example:
            sequence = persistence.load("seq-abc123")
        """
        conn = sqlite3.connect(str(self.db_path))
    ...
    def search(
        ...
        Example:
            results = persistence.search("authentication bug")
            python_errors = persistence.search("error", tool="python")
        """
        conn = sqlite3.connect(str(self.db_path))
        conn.row_factory = sqlite3.Row
        cursor = conn.cursor()
    ...
    def stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            stats['success_rate'] = round(result or 0, 2)
    ...
    def export(self, sequence_id: str, output_path: str) -> None:
        """
        ...
        Example:
            persistence.export("seq-abc123", "backup.json")
        """
    ...
    def import_from(self, input_path: str) -> str:
        """
        ...
        Example:
            seq_id = persistence.import_from("backup.json")
        """
        with open(input_path, 'r') as f:
            sequence_data = json.load(f)

        return self.save(sequence_data)
...
_global_persistence: Optional[Persistence] = None
